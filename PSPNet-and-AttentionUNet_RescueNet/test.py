...
#from util import transform, config # @sh: add 
...
import torchvision.transforms as transforms # @sh:add
...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/michael/rescuenet-v1.0_pspnet101.yaml', help='config file') # @sh : add
    #parser.add_argument('opts', help='see config/ade20k/ade20k_pspnet50.yaml for all options', default=None, nargs=argparse.REMAINDER)
    #parser.add_argument('--config', type=str, default='config/harvey/harvey_pspnet101.yaml', help='config file') # @sh : add
    parser.add_argument('opts', help='see config/michael/rescuenet-v1.0_pspnet101.yaml for all options', default=None, nargs=argparse.REMAINDER)
...
def main():
    ...
    '''##-- /end: @sh : block comment

    ##-- /begin: @sh: weighting technique
    ...
    elif args.dataset.lower() == 'michael':
        from data import Michael as dataset
    elif args.dataset.lower() == 'harvey':
        from data import Harvey as dataset
    elif args.dataset.lower() == 'harvey10':
        from data import Harvey10 as dataset
    ...
    ##-- /end: @sh: weighting technique
    
    ## --/begin: @sh: revised data loader
    # Import the requested dataset
    if args.dataset.lower() == 'camvid':
        from data import CamVid as dataset
    elif args.dataset.lower() == 'cityscapes':
...
def test(model, test_loader, class_weights, class_encoding):
    ...
    if args.imshow_batch:
        ...
        for _, batch_data in enumerate(test_loader):
            ...
            images = batch_data[0]
            paths = batch_data[1]           
            #images, paths = iter(test_loader).next()
