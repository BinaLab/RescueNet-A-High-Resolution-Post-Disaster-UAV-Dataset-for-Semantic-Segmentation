...
import torch
import datetime
from torch.utils import tensorboard # @sh: commented out
...
# @sh: arrys to save accuracy and loss values
import numpy as np
import csv
fields = ['Epoch', 'Value']
...
class BaseTrainer:
    ...
    def train(self):
        for epoch in range(self.start_epoch, self.epochs+1):
            ...
            train_accuracy.append(results['mIoU'])
            if self.do_validation and epoch % self.config['trainer']['val_per_epochs'] == 0:
                results = self._valid_epoch(epoch)
                val_epochs.append(epoch)
                val_loss.append(results['val_loss'])
                val_accuracy.append(results['val_miou'])
        ...
        filename_tr_acc = "Deeplabv3-Michael-1976-train-accuracy.csv"
        filename_val_acc = "Deeplabv3-Michael-1976-val-accuracy.csv"
        filename_tr_loss = "Deeplabv3-Michael-1976-train-loss.csv"
        filename_val_loss = "Deeplabv3-Michael-1976-val-loss.csv"
