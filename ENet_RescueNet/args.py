...
def get_arguments():
    ...
    parser.add_argument(
        "--mode",
        "-m",
        choices=['train', 'test', 'full', 'vis', 'vislab'],
        default='train',
    ...
    parser.add_argument(
        "--dataset",
        choices=['camvid', 'cityscapes', 'uavtest', 'michaeltest', 'harvey', 'rescuenet'],
        default='camvid',
    ...
    parser.add_argument( #@sh: add
        "--test-images-dir",
        type=str,
        default='test',
        help="The directory where test images are located. Default: test")
    parser.add_argument( #@sh: add
        "--extension",
        type=str,
        default='png',
        help="The image extension of the output image. Default: png")
    parser.add_argument( #@sh: add
        "--output",
        type=str,
        default='outputs',
        help="Output path to save the images")
    parser.add_argument( #@sh: add
        "--savelabel",
        type=str,
        default='savedlabels',
        help="Output path to save the label images")
